...
const BackButton: React.FC<BackButtonProps> = ({ href }) => {
  return (
    <div>
      <Link
        href={href}
        className="absolute lg:flex hidden left-8 top-24 py-2 px-4 rounded-md no-underline text-foreground bg-btn-background hover:bg-btn-background-hover flex items-center group text-sm"
      >
        <svg
